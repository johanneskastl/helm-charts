...
| mount_configuration_from_secret.secretName | string | `"my-secret"` |  |
...
| resolver.dnssec_validation | bool | `true` |  |
| resolver.forwarders[0] | string | `"80.241.218.68"` |  |
| resolver.forwarders[1] | string | `"159.69.114.157"` |  |
| resolver.forwarders[2] | string | `"176.9.93.198"` |  |
| resolver.ipv6_enabled | bool | `true` |  |
| resolver.querylog | bool | `false` |  |
...
* properly set dnssec-validation instead of hardcoding yes
