...
![Version: 0.37.2](https://img.shields.io/badge/Version-0.37.2-informational?style=flat-square) ![AppVersion: v1.102.5](https://img.shields.io/badge/AppVersion-v1.102.5-informational?style=flat-square)
...
* renovate comment in Chart.yaml before the appVersion
...
* add permission to patch the secret (thanks @Thiesjoo)
